...
export const App = () => {
  ...
  const inputSubmitHandler = prevImageSearchName => {
    if (prevImageSearchName !== imageSearchName) {
      setImageSearchName(prevImageSearchName);
      setPage(1);
      setImages([]);
    }
  };
  ...
  return (
    ...
    >
      ...
      <main>
        ...
        {images.length % 12 === 0 && images.length !== 0 && <Button onClick={loadMore} />}
      </main>
      <footer>
        {selectedImage !== null && (
